...
from dataset.caption_dataset import re_split_eval_dataset, re_nocaps_eval_dataset
...
def create_dataset(dataset, config):
    ...
    if dataset == 're_split':
        test_dataset = re_split_eval_dataset(config['split_file'], test_transform, config['image_root'], config, 'test')
        return test_dataset

    elif dataset == 're_nocaps':
        test_dataset = re_nocaps_eval_dataset(config, test_transform)
        return test_dataset
